...
wc      $FILE > $OUT_DIR/all.out
wc -l   $FILE > $OUT_DIR/all.l.out
wc -w   $FILE > $OUT_DIR/all.w.out
wc -c   $FILE > $OUT_DIR/all.c.out
wc -m   $FILE > $OUT_DIR/all.m.out
wc -lwm $FILE > $OUT_DIR/all.lwm.out
wc -wc  $FILE > $OUT_DIR/all.wc.out
wc -wm  $FILE > $OUT_DIR/all.wm.out
wc -wl  $FILE > $OUT_DIR/all.wl.out
wc -cl  $FILE > $OUT_DIR/all.cl.out
wc -ml  $FILE > $OUT_DIR/all.ml.out
